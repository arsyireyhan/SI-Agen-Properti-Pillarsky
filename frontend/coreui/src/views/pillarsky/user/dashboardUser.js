...
const DashboardUser = (props) => {
  ...
  const handlePasangIklanClick = () => {
    if (!token || token === "") {
      handleGuest();
    } else {
      history.push("/user/pasangIklan");
    }
  };
  ...
  //     default:
  //       return 'secondary'; // Set a default color for unknown statuses
  //   }
  // };

  const handleImageLoad = (event) => {
    const img = event.target;
    const container = img.closest('.imageItem'); // Adjust the class name based on your structure
            ...
            <CCard>
              <CCardBody>
                <CRow>
                  <CCol>
                    <CJumbotron>
                      <h1 className="display-2"> Iklan Dashboard User</h1>
                      <p className="lead">
                          <CButton color="primary" size="lg" onClick={handlePasangIklanClick}>
                ...
                {/* browse properti & selengkapnya */}
                <CRow>
                  <CCol sm="5">
                    <div>
                      <h3> Browse Properti </h3>
                    </div>
                  </CCol>
                  <CCol sm="7">
                ...
                <CRow>
                  {itemDisplay.map((property) => (
                    <CCol xs="12" md="4" key={property.id_property}>
                      ...
                      <CCarousel>
                        <CCarouselInner>
                          <CCarouselItem className="imageItem">
                            <img
                            className="d-block w-100"
